...
<dl>
  ...
  <dt>Methods...</dt>
    ...
    <dl>
      <dt>Custom methods</dt>
      <dd>
        Methods in addition to the Signal K defaults (i.e. 'sound' and
        'visual') methods which can be used in the method property of
        notifications generated by the plugin.
      </dd>
      <dt>Methods used for ALERT</dt>
      <dd>
        Methods to be included in the 'method' property of notifications
        with a state property value of 'alert'.
      </dd>
      <dt>Methods used for WARN</dt>
      <dd>
        Methods to be included in the 'method' property of notifications
        with a state property value of 'warn'.
      </dd>
      <dt>Methods used for ALARM</dt>
      <dd>
        Methods to be included in the 'method' property of notifications
        with a state property value of 'alarm'.
      </dd>
      <dt>Methods used for EMERGENCY</dt>
      <dd>
        Methods to be included in the 'method' property of notifications
